...
public abstract class AbstractSchedulerService extends AbstractIdleService implements SchedulerService {
  ...
  private boolean callTimeScheduler(ProgramSchedule schedule) {
    return schedule.getTrigger() instanceof TimeTrigger || schedule.getTrigger() instanceof CompositeTrigger;
  }

  private boolean callStreamSizeScheduler(ProgramSchedule schedule) {
    return schedule.getTrigger() instanceof StreamSizeTrigger || schedule.getTrigger() instanceof CompositeTrigger;
  }
